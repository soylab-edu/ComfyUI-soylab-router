...
5. **Run:** Defaults are Seedance 2.5, `higgsfield`, `auto`, 480p, 9:16, and 4 seconds. Review the prompt and cost before running. The video is saved in ComfyUI `output/SOYLAB_Router`.
